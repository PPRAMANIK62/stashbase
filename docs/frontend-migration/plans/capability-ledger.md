...
| Documents and editing | J03 | Retain / [0002](../decisions/0002-feature-runtime-and-protocol-ownership.md), [0004](../decisions/0004-runtime-scope-shared-identities-and-navigation.md), [0006](../decisions/0006-rendering-and-resource-discipline.md), [0012](../decisions/0012-persistence-commands-and-contract-evidence.md), [0015](../decisions/0015-adopt-fluid-functionalism-base-ui.md) | Markdown Rendering; Document Viewers; File Transactions; Renderer Workspace | `SourceReference`; folder-scoped `DocumentTabsRuntime`; independently disposable `DocumentRuntime`; app-owned open-document workflow; versioned `DocumentSourceApi` query; Fluid document tabs and source surface | Task 28's strict v1 session still receives only active-folder-relative tab identities; Task 30 reuses the legacy read route through a strict replacement adapter without changing its other consumers | Building | Tasks 29–30 evidence in [Subphase 3](subphases-3-documents.md) proves source identity and tab lifecycle plus validated versioned Markdown/TXT loading, explicit-folder reads, edit eligibility, cross-folder/decode read-only policy, cancellation, stale-safe cache retirement, and retryable failure UI. Saving, dirty/conflict authority, specialized viewers, and final J03 evidence remain Tasks 31–40 and finalization work. |
