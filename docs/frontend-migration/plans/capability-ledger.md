...
| Documents and editing | J03 | Retain / [0002](../decisions/0002-feature-runtime-and-protocol-ownership.md), [0004](../decisions/0004-runtime-scope-shared-identities-and-navigation.md), [0006](../decisions/0006-rendering-and-resource-discipline.md), [0012](../decisions/0012-persistence-commands-and-contract-evidence.md), [0015](../decisions/0015-adopt-fluid-functionalism-base-ui.md) | Markdown Rendering; Document Viewers; File Transactions; Renderer Workspace | `SourceReference`; folder-scoped `DocumentTabsRuntime`; independently disposable `DocumentRuntime`; active-tab `DocumentNavigationRuntime`; app-owned open-document and document-command composition; versioned `DocumentSourceApi` query/save/overwrite adapter; document-owned live draft, save barrier, conflict, Find, outline, and anchor authority; lazy retained Milkdown surface with colocated DOM adapters; validated `stashbase.externalNavigation`; Fluid document tabs, source, conflict, Find, and outline surfaces | Task 28's strict v1 session still receives only active-folder-relative tab identities; Tasks 30–35 reuse the legacy read/save and Milkdown authorities through replacement-owned adapters and runtimes; relative file links retain folder-plus-path source identity, and external HTTP(S) navigation is additive, credential-free, and main-process authorized | Building | Tasks 29–35 evidence in [Subphase 3](subphases-3-documents.md) covers source/tab lifecycle, versioned Markdown/TXT editing, save barriers, conflict recovery, bounded Writer/Reading surfaces, active-document Find and outline, duplicate-safe anchors, source-preserving file links, and safe native external navigation. Specialized editors/viewers and final J03 evidence remain Tasks 36–40 and finalization work. |
