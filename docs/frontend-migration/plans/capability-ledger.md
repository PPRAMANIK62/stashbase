...
| Documents and editing | J03 | Retain / [0002](../decisions/0002-feature-runtime-and-protocol-ownership.md), [0004](../decisions/0004-runtime-scope-shared-identities-and-navigation.md), [0006](../decisions/0006-rendering-and-resource-discipline.md), [0012](../decisions/0012-persistence-commands-and-contract-evidence.md), [0015](../decisions/0015-adopt-fluid-functionalism-base-ui.md) | Markdown Rendering; Document Viewers; File Transactions; Renderer Workspace | `SourceReference`; folder-scoped `DocumentTabsRuntime`; independently disposable `DocumentRuntime`; app-owned open-document workflow; versioned `DocumentSourceApi` query/save/overwrite adapter; document-owned live draft, save barrier, and conflict authority; lazy retained Milkdown surface; Fluid document tabs, source, and conflict surfaces | Task 28's strict v1 session still receives only active-folder-relative tab identities; Tasks 30–34 reuse the legacy read/save and Milkdown authorities through replacement-owned adapters and runtimes | Building | Tasks 29–34 evidence in [Subphase 3](subphases-3-documents.md) covers source/tab lifecycle, versioned Markdown/TXT editing, save barriers, conflict recovery, and bounded Writer/Reading surfaces. Specialized navigation, editors/viewers, and final J03 evidence remain Tasks 35–40 and finalization work. |
