...
export const STASHBASE_AGENT_RUNTIME_POLICY = [
  ...
  '- Every search targets one Folder. Folder Chat may use its bound Folder; in Library Chat, call library_info and pass the selected folder to search_library. Never broaden a search across the Library.',
