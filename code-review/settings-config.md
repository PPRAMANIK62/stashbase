...
| Settings views | `renderer/src/features/settings/ui/settings.tsx`, `ui/settings-types.ts`, `ui/managed-settings.tsx`, `ui/shell.tsx`, `ui/rows.tsx`, `ui/failure-notice.tsx`, and the panels `ui/general/general-panel.tsx`, `ui/appearance/appearance-panel.tsx` over its `ui/appearance/preset-choice.tsx`, `ui/agents/agents-panel.tsx`, `ui/ai-index/ai-index-panel.tsx`, `ui/transcription/transcription-panel.tsx`, `ui/mcp/mcp-access-panel.tsx` |
