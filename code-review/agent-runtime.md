...
| Renderer Adapter | `web-src/src/features/agent-panel/components/agentCatalog.tsx`, `chatActivation.ts`, `runtimeFailurePresentation.ts`, and [Agent Panel](agent-panel.md) |
