...
function SaturationSquare({ h, s, v, onChange }: SaturationSquareProps) {
  ...
  return (
    <button
      ...
      onKeyDown={onKeyDown}
      className={cn(
        'relative w-full cursor-none touch-none border-0 bg-transparent p-0 outline-none select-none',
        shape.bg,
      )}
      style={{
...
function FormatDropdown({
  ...
  return (
    ...
    >
      <Menu.Trigger
        className={cn(
          'flex cursor-pointer items-center justify-between bg-transparent transition-colors duration-80 outline-none hover:bg-hover hover:text-foreground focus-visible:ring-1 focus-visible:ring-[color:var(--focus-ring,#6B97FF)]',
          sizeClasses.gap,
          sizeClasses.control,
          sizeClasses.px,
          sizeClasses.text,
...
const TextColorInput = forwardRef<HTMLInputElement, ColorInputProps>(
  (
    ...
    return (
      <div
        className={cn(
          'flex items-center bg-transparent px-2 transition-colors duration-80 select-none focus-within:ring-1 focus-within:ring-[color:var(--focus-ring,#6B97FF)] hover:bg-hover active:bg-active',
          sizeClasses.control,
          shape.input,
          className,
        )}
      ...
      >
        {prefix && (
          <span
            className={cn(
              'mr-1 text-muted-foreground select-none',
        ...
        <input
          ...
          className={cn(
            'min-w-0 flex-1 bg-transparent text-foreground tabular-nums outline-none',
            sizeClasses.text,
  ...
  (
    ...
    return (
      <NumberField.Root
        ...
        format={format}
        className={cn(
          'flex items-center bg-transparent transition-colors duration-80 select-none focus-within:ring-1 focus-within:ring-[color:var(--focus-ring,#6B97FF)] hover:bg-hover active:bg-active',
          sizeClasses.control,
          shape.input,
          className,
        )}
...
function EyeDropperButton({ onPick }: { onPick: (hex: string) => void }) {
  ...
  return (
    <button
      ...
      className={cn(
        'flex cursor-pointer items-center justify-center bg-transparent text-muted-foreground transition-colors duration-80 outline-none hover:bg-hover hover:text-foreground focus-visible:ring-1 focus-visible:ring-[color:var(--focus-ring,#6B97FF)] active:bg-active',
        sizeClasses.control,
        sizeClasses.px,
        shape.input,
      )}
    ...
    const root = (
      ...
      >
        <div ref={ref} className="inline-flex">
          <Popover.Trigger
            className={cn(
              'flex cursor-pointer items-center border border-border bg-transparent transition-colors duration-80 outline-none hover:bg-hover focus-visible:ring-1 focus-visible:ring-[color:var(--focus-ring,#6B97FF)]',
              sizeClasses.gap,
              sizeClasses.control,
              compact ? 'px-1.5' : 'px-2',
              shape.input,
          ...
          >
            {triggerLabel && triggerLabelPosition === 'left' && (
              <span className={cn('px-1 text-muted-foreground select-none', sizeClasses.text)}>
                {triggerLabel}
              </span>
            )}
