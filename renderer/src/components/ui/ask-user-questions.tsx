            ...
            <span className="inline-grid w-full">
              <textarea
                ...
                className={cn(
                  ...
                  'col-start-1 row-start-1 m-0 block w-full resize-none overflow-hidden border-0 bg-transparent p-0 leading-snug text-foreground outline-none placeholder:text-muted-foreground',
                  sizeClasses.text,
                )}
      ...
      >
        ...
        <Field.Root invalid={freeTextError !== null} className="contents">
                    ...
                    <Field.Control
                      ...
                      render={
                        <textarea
                          ...
                          className={cn(
                            'm-0 block w-full resize-none overflow-hidden border-0 bg-transparent p-0 leading-snug text-foreground outline-none placeholder:text-muted-foreground',
                            sizeClasses.text,
                          )}
                          style={{ fontVariationSettings: fontWeights.medium }}
                        />
          ...
          {/* Footer — outside the morphing region, so the animating height never
              ...
              in lockstep. */}
          {showFooter && (
            <div className={cn('pt-1', compact ? 'px-3.5 pb-1.5 sm:px-4' : 'px-4 pb-2 sm:px-5')}>
                    ...
                    <Field.Error
                      ...
                      render={
                        <motion.p
                          ...
                          className="min-w-0 px-2 text-left text-[12px] leading-snug text-destructive sm:px-3"
                        />
                      }
                    >
                      {freeTextError}
...
function Row({
  ...
  return (
    <div
      ...
      onKeyDown={onKeyDown}
      className={cn(
        'relative z-10 flex cursor-pointer outline-none select-none',
        ...
        chipPosition === 'left' ? (isMulti ? 'pr-3 pl-1.5' : 'pr-1.5 pl-1.5') : 'pr-1.5 pl-3',
        shape.item,
      )}
    >
