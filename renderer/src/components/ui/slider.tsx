...
const ComfortableSlider = forwardRef<HTMLDivElement, SliderComfortableProps>(
  (
    ...
    // Pips are useful landmarks only for a small discrete scale. A one-unit
    // 0–100 threshold would render 101 decorative dots, so keep the stepping
    // behavior but omit the visual noise once the scale exceeds 12 positions.
    const showPips = variant === 'pips' && pipCount <= 12;
