...
const InputCopy = forwardRef<HTMLDivElement, InputCopyProps>(
  (
          ...
          <AnimatePresence mode="wait" initial={false}>
            {status === 'error' ? (
              ...
              >
                ...
                <span className="inline-grid text-left select-none">
    ...
    const valueElement = (
      <span
        className={cn(
          'min-w-0 flex-1 truncate text-left font-mono text-foreground select-none',
          sizeClasses.text,
          rowPy,
    ...
    const button = (
      <button
        ...
        className={cn(
          'group flex w-full cursor-pointer items-center transition-all duration-80 outline-none',
