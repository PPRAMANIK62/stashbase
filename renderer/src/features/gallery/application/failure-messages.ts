 ...
 *
 * The copy port is wired in composition over the project registry's own import, and the
 * project registry owns how its refusals read — a private repository, a name already
