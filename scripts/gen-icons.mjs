...
const MAP = [
  ...
  ['PlusIcon', 'plus', 'Add — the composer’s attach control and other additive rows.'],
  ['NewChatIcon', 'square-pen', 'New Chat — the compose mark (the ChatGPT/Claude idiom), shared by the sidebar row and the collapsed-sidebar titlebar button so the action keeps one glyph.'],
