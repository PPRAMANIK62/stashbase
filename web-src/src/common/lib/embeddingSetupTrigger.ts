/** How any surface asks the setup dialog for search by meaning to open manually — the Files-panel
 * Set up entry, the By meaning search mode, or Settings. Mirrors `settingsTrigger`; the gate
