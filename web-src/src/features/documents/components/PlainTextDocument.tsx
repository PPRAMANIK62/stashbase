  ...
  const view = new EditorView({
    ...
    state: EditorState.create({
      ...
      extensions: [
        ...
        // The shared surface CHROME only (codeSurface.ts) — gutter, padding,
        // selection, active line — so this editor cannot drift from the JSON
        // source view and the generic code viewer. Deliberately not
        // `stashbaseCodeSurface`, which also carries syntax colouring: a .txt
        // is literal text, and no language mode enters this component.
        stashbaseCodeTheme,
      ],
    }),
  });
